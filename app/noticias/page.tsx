  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8 animate-fade-in">
      ...
      <div className="bg-gradient-to-br from-blue-900 via-[#0040A8] to-[#003399] rounded-3xl p-6 sm:p-10 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="mt-6 pt-4 border-t border-white/10 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs text-blue-200">
          ...
          <button
            onClick={fetchNews}
            disabled={loading}
            className="flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-xl bg-white/10 hover:bg-white/20 transition-all font-semibold active:scale-95 w-full sm:w-auto min-h-[44px] cursor-pointer"
          >
            <RefreshCw
      ...
      <div className="bg-white rounded-3xl border border-slate-200 p-5 shadow-sm space-y-4">
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-sm text-slate-800 placeholder-slate-400 focus:bg-white focus:border-[#0040A8] focus:ring-2 focus:ring-blue-100 transition-all min-h-[44px]"
            />
          </div>
          ...
          {searchQuery && (
            <button
              ...
              className="px-3 py-2 text-xs font-semibold text-slate-500 hover:text-slate-800 self-center cursor-pointer min-h-[36px]"
            >
              Limpar busca
            </button>
          )}
          ...
          {FILTER_SOURCES.map((sourceName) => {
            ...
            return (
              <button
                ...
                className={`px-3 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all duration-150 border cursor-pointer min-h-[36px] flex items-center ${
                  isSelected
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-2 scrollbar-none sm:scrollbar-thin pt-2 border-t border-slate-100">
          <span className="text-xs font-bold text-slate-400 flex items-center gap-1 flex-shrink-0">
          ...
          {FILTER_TAGS.map((tag) => {
            ...
            return (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold whitespace-nowrap transition-all duration-150 border cursor-pointer min-h-[34px] flex items-center ${
                  isSelected
