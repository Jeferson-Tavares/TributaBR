      ...
      <div className="bg-gradient-to-br from-slate-900 via-[#0040A8] to-slate-900 rounded-3xl p-6 sm:p-10 text-white shadow-xl relative overflow-hidden">
        <div className="relative z-10 max-w-3xl space-y-3">
          ...
          <p className="text-sm text-blue-100/90 leading-relaxed font-normal">
            Conheça o propósito do <strong>TRIBUTABR</strong>, nossa metodologia editorial independente 
            e os canais diretos para sugestões, parcerias, correções e suporte à comunidade.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl border border-slate-200 p-6 sm:p-8 shadow-sm space-y-6 text-sm text-slate-700 leading-relaxed">
          <div className="space-y-3">
            ...
            <p>
              O <strong>TRIBUTABR</strong> nasceu da união de profissionais das áreas contábil, jurídica e de engenharia de software 
              com o compromisso cívico de transformar textos legislativos de alta complexidade em ferramentas intuitivas, 
              didáticas e transparentes para a sociedade brasileira.
            </p>
            <p>
              A promulgação da <strong>Emenda Constitucional nº 132/2023</strong> e a tramitação dos 
              <strong> PLPs 68/2024 e 108/2024</strong> inauguram uma era de simplificação (extinção de ICMS, ISS, IPI, PIS e Cofins 
              e unificação no IVA Dual - CBS e IBS). No entanto, o período de transição (2026 a 2033) exige planejamento minucioso 
              por parte de micro, pequenas e grandes empresas, bem como entendimento claro pelos consumidores finais.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-slate-100">
            <div className="p-4 rounded-2xl bg-blue-50/60 border border-blue-100 space-y-1.5">
              <span className="text-xs font-bold text-[#0040A8] uppercase tracking-wider block">Independência</span>
              <p className="text-xs text-slate-600">
                Sem vínculo partidário ou governamental. Foco estritamente na análise técnica e didática.
              </p>
            </div>
            <div className="p-4 rounded-2xl bg-emerald-50/60 border border-emerald-100 space-y-1.5">
              <span className="text-xs font-bold text-[#009A44] uppercase tracking-wider block">Rigor Legal</span>
              <p className="text-xs text-slate-600">
                Parâmetros sempre respaldados em textos normativos reais e jurisprudência vinculante.
              </p>
            </div>
            <div className="p-4 rounded-2xl bg-amber-50/60 border border-amber-100 space-y-1.5">
              <span className="text-xs font-bold text-amber-700 uppercase tracking-wider block">Acesso Gratuito</span>
              <p className="text-xs text-slate-600">
                Ferramentas abertas e gratuitas para capacitar cidadãos, empreendedores e estudantes.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3 pt-2">
            ...
            <p className="text-xs text-slate-600">
              Nossas calculadoras, artigos e gráficos são parametrizados com base nas notas técnicas do 
              <strong> Ministério da Fazenda</strong>, nos pareceres do <strong>Senado Federal</strong> e da 
              <strong> Câmara dos Deputados</strong>, nos atos conjuntos do <strong>Comitê Gestor do IBS</strong> e 
              em súmulas do <strong>Supremo Tribunal Federal</strong> (como a Súmula Vinculante 28). Atualizamos 
              as premissas de cálculo continuamente conforme o avanço de votações no Congresso Nacional.
            </p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-sm space-y-5">
            ...
            <div className="space-y-4 text-xs text-slate-600">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <span className="font-bold text-slate-800 block text-xs">E-mail Editorial & Suporte</span>
                  <a href="mailto:contato@tributabr.com.br" className="text-[#0040A8] font-semibold hover:underline">
                    contato@tributabr.com.br
                  </a>
                  <span className="text-[11px] text-slate-400 block mt-0.5">Resposta em até 24h úteis</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <span className="font-bold text-slate-800 block text-xs">Localização Editorial</span>
                  <p className="text-slate-600">Brasília, DF & São Paulo, SP</p>
                  <span className="text-[11px] text-slate-400 block mt-0.5">Brasil • Cobertura Nacional</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <span className="font-bold text-slate-800 block text-xs">Transparência & LGPD</span>
                  <p className="text-slate-600">Atendimento aos direitos do titular de dados</p>
                  <Link href="/politica-de-privacidade" className="text-[#0040A8] underline hover:text-[#003399]">
            ...
            <div className="p-3 bg-slate-50 rounded-2xl border border-slate-200 text-[11px] text-slate-500 leading-relaxed">
              💡 <strong>Imprensa e Pesquisadores:</strong> Interessados em citações de dados ou estudos comparativos sobre o IVA Dual podem solicitar material exclusivo via e-mail.
            </div>
          </div>
      ...
      <div className="bg-white rounded-3xl border border-slate-200 p-6 sm:p-10 shadow-sm space-y-6">
        <div className="max-w-2xl">
          ...
          <p className="text-xs sm:text-sm text-slate-600 mt-1">
            Preencha o formulário abaixo. Sua mensagem será direcionada à equipe técnica responsável pela curadoria tributária.
          </p>
        </div>
        ...
        {submitted ? (
          <div className="p-6 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-950 space-y-3 animate-fade-in max-w-xl">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              Agradecemos seu contato. Nossa equipe editorial analisará sua mensagem e responderá pelo 
          ...
          <form onSubmit={handleSubmit} className="space-y-4 max-w-2xl">
            ...
            <div>
              ...
              >
                <option value="Dúvida Geral">Dúvida sobre a Reforma Tributária</option>
                <option value="Feedback dos Simuladores">Sugestão / Feedback dos Simuladores</option>
                <option value="Correção de Conteúdo">Apontamento de Correção Normativa</option>
                <option value="Parceria ou Imprensa">Contato Institucional / Imprensa</option>
                <option value="Privacidade / LGPD">Privacidade e Dados (LGPD)</option>
              </select>
            </div>
            ...
            <p className="text-[11px] text-slate-400">
              * Suas informações serão utilizadas estritamente para responder à sua solicitação, em conformidade com nossa{" "}
              <Link href="/politica-de-privacidade" className="text-[#0040A8] underline hover:text-[#003399]">
